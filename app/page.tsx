...
export default function Home() {
  return (
    <main className="h-screen md:bg-charcoalGray text-charcoalGray md:flex md:justify-center md:items-center">
      {/* container */}
      <section className="flex flex-col md:flex-row relative h-full md:w-fit md:mx-auto md:h-2/3 md:bg-white md:justify-center md:rounded-[1rem] md:p-[1rem] md:shadow-lg md:drop-shadow-lg">
        {/* Image */}
